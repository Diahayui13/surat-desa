        ...
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.ttddigital') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.ttddigital') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-blue-50' }}">
                    <i class="fa-solid fa-pen-nib w-5"></i>
                    <span>TTD Digital</span>
                </a>
                
                <a href="{{ route('admin.profiladmin') }}" 
...
<script>
  ...
  // Jika resize ke desktop, pastikan body bisa scroll lagi
