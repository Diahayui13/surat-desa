...
<body class="antialiased bg-gradient-to-br from-pink-50 to-blue-50 min-h-screen">
    ...
    <nav class="bg-white shadow-sm py-3 px-4 flex justify-between items-center">
        ...
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit"
                class="bg-pink-400 hover:bg-pink-500 text-white text-sm font-semibold py-1.5 px-4 rounded-xl transition">
                Logout
            </button>
        </form>
    </nav>
