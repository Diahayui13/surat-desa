...
<div class="min-h-screen bg-gray-50 p-4 md:p-8">
    <div class="max-w-lg mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <!-- List Jenis Surat (Alternative View) -->
            <div class="space-y-2">
                @foreach($jenisSurat as $jenis)
                <a href="{{ route('warga.buat-surat', $jenis['slug']) }}" 
                   class="block p-4 rounded-xl border-2 border-gray-100 hover:border-blue-500 hover:bg-blue-50 transition group">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="bg-blue-100 group-hover:bg-blue-500 w-10 h-10 rounded-lg flex items-center justify-center transition">
                                <i class="{{ $jenis['icon'] }} text-blue-600 group-hover:text-white transition"></i>
                            </div>
                            <span class="font-medium text-gray-700 group-hover:text-blue-700 transition">{{ $jenis['nama'] }}</span>
                        </div>
