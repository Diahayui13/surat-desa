...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <a href="{{ route('admin.ttddigital') }}" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition group">
                <div class="flex items-center gap-4">
                    <div class="bg-blue-100 p-4 rounded-full group-hover:bg-blue-200 transition">
                        <i class="fa-solid fa-pen-nib text-blue-500 text-xl"></i>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-800 mb-1">TTD Digital</h4>
                        <p class="text-sm text-gray-500">Tanda tangani surat digital</p>
                    </div>
                </div>
            </a>

            <a href="{{ route('admin.surat') }}" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition group">
                <div class="flex items-center gap-4">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <a href="{{ route('admin.surat.detail', $surat->id) }}" class="text-pink-500 hover:text-pink-700 text-sm font-medium">
                                        Lihat Detail →
                                    </a>
                                </td>
                            </tr>
