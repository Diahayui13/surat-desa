                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-3">
                            ...
                            <img src="{{ asset('storage/' . $surat->file_ktp) }}" 
                                 class="w-full h-32 object-cover rounded" alt="KTP">
                        </div>
                        @endif
                        ...
                        <div class="border border-gray-200 rounded-lg p-3">
                            ...
                            <img src="{{ asset('storage/' . $surat->file_kk) }}" 
                                 class="w-full h-32 object-cover rounded" alt="KK">
                        </div>
                        @endif
                        ...
                        <div class="border border-gray-200 rounded-lg p-3">
                            ...
                            <img src="{{ asset('storage/' . $surat->file_surat_pernyataan) }}" 
                                 class="w-full h-32 object-cover rounded" alt="Surat">
                        </div>
                        @endif
                        ...
                        <div class="border border-gray-200 rounded-lg p-3">
                            ...
                            <img src="{{ asset('storage/' . $surat->file_foto_rumah) }}" 
                                 class="w-full h-32 object-cover rounded" alt="Rumah">
                        </div>
                        @endif
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-2">
                        @if($surat->status === 'Selesai')
                            ...
                            <a href="{{ route('admin.template.preview', $surat->id) }}" 
                               target="_blank"
                               class="block w-full bg-green-100 hover:bg-green-200 text-green-700 font-medium py-3 rounded-lg transition text-center">
                            ...
                            <a href="{{ route('admin.template.download-pdf', $surat->id) }}" 
                               class="block w-full bg-purple-100 hover:bg-purple-200 text-purple-700 font-medium py-3 rounded-lg transition text-center">
                        ...
                        <button onclick="window.print()" 
                                class="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 rounded-lg transition text-center">
